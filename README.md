...
- [x] Working with Wikimedia - consuming large data 
    - GET - url 
    - POST 
    - PUT 
    - DELETE 
...
- [ ] spring boot application with kafka 
    - com.ibm.kafka.spring
    - com.ibm.kafka.spring.service
    - com.ibm.kafka.spring.controller
    - com.ibm.kafka.spring.config
    - com.ibm.kafka.springs.repo
- [ ] Metrics with Kafka 
